# Inmarco FZC - Website Content

## 1. Brand & Company Information

### 1.1 Company Name
- **Registered Name:** Inmarco FZC
- **Brand Name:** Inmarco
- **Tagline:** Innovation in Industrial Fluid Sealing

### 1.2 Logo Assets
*Will be provided separately by Chandan*
- Primary Logo (Light Background)
- Primary Logo (Dark Background)
- Icon / Favicon
- Brand Guidelines (Font Style, Sizes, etc.)

### 1.3 Contact Information
- **Primary Email:** sales@inmarco.ae
- **Primary Phone:** +971 55 948 7218
- **Secondary Phone:** +971 65 578 378
- **Registered Office:** P.O. Box 120284, SAIF-Zone, Sharjah, UAE
- **Working Hours:** TBD

### 1.4 Social Media Links
- **LinkedIn:** https://www.linkedin.com/company/inmarco/
- **YouTube:** TBD
- **Instagram:** TBD
- **Facebook:** TBD
- **X (Twitter):** TBD
...
**Subheadline:** Advanced fluid sealing solutions designed for extreme pressure, temperature, and performance.
...
- Oil & gas, power, petrochemical, mining sectors
...
### 2.4 Product Categories Tab
*See Products.md for detailed list*

### 2.5 "Fluid Sealing Simplified" – Powered by Inmarco
*Section content TBD*
...
1. **Innovation**
   - We continuously push boundaries by combining materials science and engineering expertise to deliver high-performance sealing solutions for mission-critical applications.

2. **Customer Partnership**
   - We work hand-in-hand with our customers, understanding their needs and delivering tailored solutions that drive their success.

3. **Sustainability**
   - We are committed to developing eco-friendly sealing technologies that protect resources and reduce environmental impact.

4. **Excellence**
   - Our culture thrives on technical, operational, and service excellence, ensuring reliability and quality in every product.

5. **Integrity**
   - We uphold transparency, trust, and ethical practices in all our relationships and operations.

6. **Continuous Improvement**
   - We embrace a mindset of learning and growth, striving to improve processes, products, and performance every day in partnership with our customers and business associates.

7. **Visionary Leadership**
   - Guided by the foresight of our leadership, we set industry benchmarks and inspire progress across global markets.
...
### Hero Section
- Full-width industrial image (e.g., valve close-up or braided graphite texture)
- Overlay text "Engineering Reliability for a Fluid World"
- Animated grid background

### Company Overview
- 2-column layout (text + product image)
- Background image with gradient overlay
- Animated key points with check icons

### Mission/Vision
- Minimalist cards or icon highlights

### Our Difference
- 4-column icon grid with subtle animation

### Footprint
- Interactive world/region map with highlighted markets

### Sustainability & Future
- Grey background section with AI/innovation imagery

### Our People
- Warm-toned images of real engineers

### Contact CTA
- Contrasting color block with buttons to Products and Contact pages

---

## 5. Page Templates

### 5.1 Individual Industry Page Template
- Industry Name
- Industry Overview
- Applications (list specific use cases)
- Challenges We Solve
- Recommended Products / Solutions

### 5.2 Product Category Page Template
- Category Name
- Category Description
- Products Under This Category (table format)

### 5.3 Individual Product Page Template
- Product Name
- Product Description
- Key Features
- Technical Specifications (Material, Size Range, Temperature, Pressure, Standards)
- Applications
- Advantages / Benefits
...
- **Address:** P.O. Box 120284, SAIF-Zone, Sharjah, UAE
- **Phone:** +971 55 948 7218 / +971 65 578 378
...
## Notes
- Landing page with graphite color background and sustainability colorful photos
- Emphasis on eco-friendly, non-asbestos solutions
- 24×7 on-site service capabilities
- API certification highlights
